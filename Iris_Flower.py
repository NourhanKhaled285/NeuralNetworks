...
def run_backprobagation():
    ...
    Lhiddenlayers=Label(back_ProbForm, textvariable=variable_Lhidden_layers, bg='#E0B0FF', fg='#FFFF00', font='Andalus 10 italic bold')
    Lneurons=Label(back_ProbForm, textvariable=variable_Lneurons, bg='#E0B0FF', fg='#FFFF00', font='Andalus 10 italic bold')
    ...
    hidden_layers_txt.place(x=285,y=90)
    neurons_txt.place(x=285,y=130)
    lear_rate_txt.place(x=285, y=210)
    epochs_txt.place(x=285, y=170)
...
def linear_classification():
    ...
    Lepochs = Label(top,textvariable=variable_Lepochs,bg='#E0B0FF', fg='#FFFF00',font='Andalus 10 italic bold')
    Lrate = Label(top,textvariable=variable_Lrate,bg='#E0B0FF', fg='#FFFF00',font='Andalus 10 italic bold')
    Lthreshold=Label(top,textvariable=variable_threshold,bg='#E0B0FF', fg='#FFFF00',font='Andalus 10 italic bold')
